...
const buttonVariants = tv({
  base: [
    ...
    'relative inline-flex pointer-events-auto no-drag-region items-center justify-center whitespace-nowrap rounded-lg border text-center font-medium shadow-sm transition-all duration-200 ease-out',
    // disabled
